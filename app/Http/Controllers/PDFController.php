...
class PDFController extends Controller
{
    ...
    public function generateInvoicePDF()
    {
        ...
        return view('myPDF');
        // return view('resources.views.myPDF',compact('invoicenumber','invoicedate','customer_name','customer_number','brand','remark','warranty_card','warranty_card','cost','prepayment','user_name'));
    }
}